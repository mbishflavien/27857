...
public class Entity {
    ...
    public Entity(int id, String createdDate, String updatedDate) {
        ...
        if (createdDate == null || createdDate.isEmpty()) throw new IllegalArgumentException("Error: Created date required.");
        if (updatedDate == null || updatedDate.isEmpty()) throw new IllegalArgumentException("Error: Updated date required.");
        this.id = id;
